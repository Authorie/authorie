    ...
    <>
      ...
      {book.status === BookStatus.INITIAL && (
        <button
          ...
          className="h-8 w-32 rounded-md bg-gradient-to-b from-authBlue-500 to-authBlue-600 text-sm font-semibold text-white outline-none hover:bg-gradient-to-b hover:from-authBlue-600 hover:to-authBlue-700 focus:outline-none"
        >
          Start Writing
        </button>
      )}
      {book.status === BookStatus.DRAFT && (
        <button
          ...
          className="h-8 w-32 rounded-lg bg-gradient-to-b from-green-400 to-green-500 text-sm font-semibold text-white outline-none hover:bg-gradient-to-b hover:from-green-500 hover:to-green-600 focus:outline-none"
        >
          Publish
        </button>
      )}
      {book.status === BookStatus.PUBLISHED && (
        <button
          ...
          className="h-8 w-32 rounded-lg bg-gradient-to-b from-gray-400 to-gray-500 text-sm font-semibold text-white outline-none hover:bg-gradient-to-b hover:from-gray-500 hover:to-gray-600 focus:outline-none"
        >
          Complete
        </button>
      )}
      {(book.status === BookStatus.INITIAL ||
        ...
        <button
          ...
          className="h-8 w-32 rounded-lg bg-gradient-to-b from-red-400 to-red-500 text-sm font-semibold text-white outline-none hover:bg-gradient-to-b hover:from-red-500 hover:to-red-600 focus:outline-none"
        >
          Delete
        </button>
      )}
