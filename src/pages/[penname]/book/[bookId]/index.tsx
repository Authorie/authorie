        ...
        <div className="ml-7 mb-20 flex flex-col">
          ...
          <div className="mt-8 gap-1">
            <div className="mb-3 flex flex-col">
              <h2 className="text-xl font-semibold">{books[0].author}</h2>
              <p className="text-sm font-light">{books[0].category}</p>
            </div>
        ...
        <div className="flex flex-col">
          <div className="flex h-52 w-3/5 flex-col justify-center gap-5">
            <div className="flex gap-4">
              <h1 className="text-3xl font-bold">{books[0].title}</h1>
              <PencilSquareIcon className="bg-7 w-7 text-white" />
            </div>
            <p className="text-xs font-light">{books[0].description}</p>
          </div>
